...
cat monoclonal.ldhel.input.list | parallel echo 'max_lk --num_threads 24 -l output/{/}.lk -p output/{/}.pade -m mut_mat.txt -s {}.ldhelmet.snps' | xargs -P2 -n11 time ldhelmet
